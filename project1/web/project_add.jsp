...
<br />
<table wfidth="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="100%" height="30" bgcolor="#80C6FF" class="titletxt">&#8226;建设工程报建—项目信息录入（以下带<span class="txtred">*</span>为必填项）</td>
    </tr>
    <tr>
        <td height="30" align="center">
            <form id="form1" name="form1" method="post" action="addProjectServlet">
                <table width="100%" border="1" align="center"  cellpadding="0" cellspacing="0" bgcolor="#E7E7E7">
                    <tr>
                        ...
                        <td height="30" align="left"><label for="textfield"></label>
                            <input  height="20" width="400" type="text" name="projectId" id="textfield" required/>
                            <span class="txtred">*</span></td>
                    </tr>
                    <tr>
                        <td width="24%" height="30" align="right" class="txt"><span class="txt">工程名称：</span></td>
                        <td height="30" align="left"><input  height="20" width="400" type="text" required name="projectName" id="textfield2" />
                            <span class="txtred">*</span></td>
                    </tr>
                    <tr>
                        <td height="30" align="right" class="txt"><span class="txt">报建申请单位：</span></td>
                        <td height="30" align="left"><input  height="20" width="400" type="text" required name="apply" id="textfield3" />
                            <span class="txtred">*</span></td>
                    </tr>
                    <tr>
                        <td height="30" align="right" class="txt">所有制性质：</td>
                    ...
                    <tr>
                        ...
                        <td height="30" align="left"><input  height="20" width="150" type="text" name="textfield9" id="textfield9" /></td>
                    </tr>
                    <tr>
                        <td height="30" align="right" class="txt">建设单位电话：</td>
                        <td height="30" align="left"><input  height="20" width="200" type="text" name="textfield6" id="textfield6" /></td>
                    </tr>
                    <tr>
                        <td height="30" align="right" class="txt">建设单位地址：</td>
                        <td height="30" align="left"><span class="txtred">
            <input  height="20" width="400" type="text" name="textfield7" id="textfield7" />
          </span></td>
                    </tr>
                    <tr>
                        <td height="30" align="right" class="txt">总投资（万元）：</td>
                        <td height="30" align="left"><input  height="20" width="150" type="text" name="textfield11" id="textfield11" /></td>
                    </tr>
                </table>
