create
database if not exists java_chatroom charset utf8;
use
chatroom;
...
insert into user
values (null, 'lisi', '123');
insert into user
values (null, 'wangwu', '123');
-- 创建好友表
...
values (1, '2000-05-01 00:00:00');
insert into message_session
values (2, '2000-06-01 00:00:00');
...
insert into message
values (2, 2, 2, '随便', '2000-05-01 17:01:00');
insert into message
values (3, 3, 3, '那吃面?', '2000-05-01 17:02:00');
insert into message
values (4, 4, 4, '不想吃', '2000-05-01 17:03:00');
insert into message
values (5, 5, 5, '那你想吃啥', '2000-05-01 17:04:00');
insert into message
values (6, 2, 1, '随便', '2000-05-01 17:05:00');
insert into message
values (7, 1, 1, '那吃米饭炒菜?', '2000-05-01 17:06:00');
insert into message
