...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="30" align="center"><form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/update">
            <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#E7E7E7">
                <tr>
                    ...
                    <td height="30" align="left"><label for="projectId"></label>
                        <input  height="20" width="400" type="text" name="projectId" id="projectId" />
                        <span class="txtred">*</span></td>
                </tr>
                <tr>
                    <td width="24%" height="30" align="right" class="txt"><span class="txt">工程名称：</span></td>
                    <td height="30" align="left"><input  height="20" width="400" type="text" name="projectName" id="projectName" />
                        <span class="txtred">*</span></td>
                </tr>
                <tr>
                    <td height="30" align="right" class="txt"><span class="txt">报建申请单位：</span></td>
                    <td height="30" align="left"><input  height="20" width="400" type="text" name="textfield3" id="textfield3" />
                        <span class="txtred">*</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td height="30" align="left"><input  height="20" width="150" type="text" name="deputyName" id="deputyName" /></td>
                </tr>
                <tr>
                    <td height="30" align="right" class="txt">建设单位电话：</td>
                    <td height="30" align="left"><input  height="20" width="200" type="text" name="telephone" id="telephone" /></td>
                </tr>
                <tr>
                    <td height="30" align="right" class="txt">建设单位地址：</td>
                    <td height="30" align="left"><span class="txtred">
            <input  height="20" width="400" type="text" name="addr" id="addr" />
          </span></td>
                </tr>
                <tr>
