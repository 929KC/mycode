...
public class SortUtils {
    ...
    public static void countSort(int[] array) {
        ...
        for (int i = 0; i < count.length; i++) {
            while (count[i] != 0) {
                array[index++] = mindata + i;//最小值加下标即为元素
                count[i]--;
            }
        }
    }
   ...
   public static int [] radixSort(int [] array){
       ...
       int N = 1;
       int maxdataue = array[0];
       for (int element : array) {
           if (element > maxdataue) {
               maxdataue = element;
           }
       }
       while (maxdataue / 10 != 0) {
           maxdataue = maxdataue / 10;
           N += 1;
       }
       for (int i = 0; i < N; i++) {
    ...
    /**
     * Gets the maximum and minimum dataues in the array
     * @param arr
     * @return
     */
    private static int[] getMinAndMax(List<Integer> arr) {
        int maxdataue = arr.get(0);
        int mindataue = arr.get(0);
        for (int i : arr) {
            if (i > maxdataue) {
                maxdataue = i;
            } else if (i < mindataue) {
        ...
        return new int[] { mindataue, maxdataue };
    }
